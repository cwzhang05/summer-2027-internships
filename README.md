...
A list of tech internships for Summer 2027 and off-season terms (fall, winter, spring) in the US. Maintained by me for now.
...
- US-based positions (US-based remote is fine)
- Summer 2027 and off-season terms

Roles outside this are out of scope. See [CONTRIBUTING.md](CONTRIBUTING.md) before adding one.

## about

I'm US-based, so for now this list is US only and built for me. If it ever gets more stars, I'm open to changing it based on what people using it need, including adding Canada. I want to keep it active and update it daily. If at some point I can't, I'd rather hand it to someone who can keep it going than let it go inactive. Probably won't come to that. For now I made it for myself and for anyone else who needs it.
...
| D. E. Shaw | Quantitative Analyst Intern | New York, NY | [apply](https://www.deshaw.com/careers/quantitative-analyst-intern-new-york-summer-2027-5890) | 2026-04-29 |
| D. E. Shaw | Quantitative Analyst Intern (PhD) | New York, NY | [apply](https://www.deshaw.com/careers/quantitative-analyst-ph-d-intern-new-york-summer-2027-5891) | 2026-04-29 |
| Aquatic Capital | Quantitative Researcher Intern | Chicago, IL | [apply](https://job-boards.greenhouse.io/aquaticcapitalmanagement/jobs/8489186002) | 2026-04-02 |
...
| Microsoft | [Learn Student Ambassadors](https://mvp.microsoft.com/studentambassadors) | ambassador program | rolling |

## programs always open

| org | opportunity | type |
| --- | --- | --- |
| Google | [Summer of Code](https://summerofcode.withgoogle.com/) | open-source, stipend, open to intl |
| Outreachy | [Outreachy](https://www.outreachy.org/) | open-source, stipend, open to intl |

## open source programs

| program | focus | timeline |
| --- | --- | --- |
| [LFX Mentorship](https://lfx.linuxfoundation.org/tools/mentorship/) | Linux Foundation projects | multiple batches |
| [Summer of Bitcoin](https://www.summerofbitcoin.org/) | bitcoin, blockchain | summer |
| [Hyperledger Mentorship](https://wiki.hyperledger.org/display/INTERN/Hyperledger+Mentorship+Program) | blockchain | multiple batches |
| [Open Mainframe Mentorship](https://openmainframeproject.org/community/mentorship-program/) | mainframe tech | multiple batches |
...
I put together these internship and recruiting tips to make the process a little easier. Good luck with recruiting, and I hope this helps you land a great opportunity.
...
Coffee chats are one of the best uses of your time, since every person you talk to can teach you something and the people you impress are the ones who advocate for you later.
